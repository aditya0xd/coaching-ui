            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <p className="text-foreground/90 font-medium text-lg leading-relaxed">
                  Based on your goals, availability, and consistency barriers,
                  you respond best to a structured, low-friction training system
                  that prioritizes physiological efficiency over sheer volume.
                </p>
                <p className="text-muted-foreground text-base leading-relaxed">
                  Clients with this profile typically see the highest ROI
                  through personalized programming that incorporates managed
                  intensity cycles and direct accountability check-ins.
                </p>
              </div>
              ...
              <div className="bg-muted/5 border-l-4 border-accent p-6 rounded-r-xl">
                ...
                <p className="text-muted-foreground text-sm font-medium italic">
                  Focus on 'Minimum Effective Dose' training and a low-friction
                  nutritional framework to ensure long-term adherence.
                </p>
              </div>
            </div>
