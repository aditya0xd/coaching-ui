...
export function WhoIsThisFor() {
  ...
  const audiences = [
    {
      image: "/assets/audiences/men.png",
      title: ["Young", "Men"],
      description:
        "You want visible muscle and fat loss but feel stuck, inconsistent, or overwhelmed in the gym.",
      height: "h-[450px] md:h-[550px]",
    },
    {
      image: "/assets/audiences/women.png",
      title: [`Young`, `Women`],
      description:
        "You want a lean, strong physique without extreme dieting or overtraining.",
      height: "h-[450px] md:h-[650px] md:-mt-12",
    },
    {
      image: "/assets/audiences/athlete.png",
      title: ["Comeback", "Athletes"],
      description:
        "Build lean muscle, drop unnecessary fat, and improve on-field performance — without losing speed or mobility.",
      height: "h-[450px] md:h-[550px]",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-7xl font-black mb-8 text-white tracking-tighter uppercase italic leading-none">
              Who Is This<span className="text-accent"> Coaching For?</span>
            </h2>
            <p className="text-zinc-400 text-xl md:text-2xl leading-relaxed font-light">
              This program is designed for driven individuals who want real
              results without the BS. We don't do "easy," we do effective.
            </p>
          </div>
          ...
          {audiences.map((audience, index) => {
            ...
            return (
              <button
                ...
                className={`object-cover relative group overflow-hidden bg-zinc-900 ${audience.height} transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] cursor-pointer block w-full text-left focus-visible:ring-2 focus-visible:ring-accent outline-none ring-inset`}
              >
                <Image
                  src={audience.image}
                  alt={audience.title.join(" ")}
                  fill
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent transition-opacity duration-700 
                ...
                <div className="absolute bottom-0 left-0 right-0 p-10 transform transition-transform duration-700">
                  <div
                    className={`w-16 h-1 bg-accent mb-6 transform origin-left transition-transform duration-700 
                  ...
                  <h3 className="text-2xl mb-2 md:text-4xl font-black md:mb-4 text-white uppercase tracking-tighter italic leading-none">
                    {audience.title[0]} <br /> {audience.title[1]}
                  </h3>
                  <div className="overflow-hidden">
                    <p
                      className={`text-zinc-300 text-lg leading-snug transform transition-all duration-700 delay-100 font-light
                ...
                {/* Corner accent */}
                <div
                  className={`absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-accent transition-all duration-700 m-4
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-zinc-500 text-lg leading-relaxed">
                If you're looking for a magic pill, a 30-day "challenge" that
                leads to nowhere, or aren't willing to put in consistent effort,
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 p-10 relative overflow-hidden group">
              ...
              <p className="text-xl md:text-2xl text-white font-medium italic relative z-10">
                "Stop looking for the easy way out. Start looking for the way
                that{" "}
